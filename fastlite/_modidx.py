...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'fastlite.core': { 'fastlite.core.Database.create': ('core.html#database.create', 'fastlite/core.py'),
            ...
            'fastlite.db_dc': {},
            'fastlite.kw': { 'fastlite.kw.NotFoundError': ('kw.py.html#notfounderror', 'fastlite/kw.py'),
                             'fastlite.kw.Table.__getitem__': ('kw.py.html#table.__getitem__', 'fastlite/kw.py'),
