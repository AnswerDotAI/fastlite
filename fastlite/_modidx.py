...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'fastlite.core': { 'fastlite.core.Database.create': ('core.html#database.create', 'fastlite/core.py'),
            ...
            'fastlite.db_dc': {},
            'fastlite.kw': { 'fastlite.kw.Table.__getitem__': ('kw.html#table.__getitem__', 'fastlite/kw.py'),
                             'fastlite.kw.Table.create': ('kw.html#table.create', 'fastlite/kw.py'),
                             'fastlite.kw.Table.get': ('kw.html#table.get', 'fastlite/kw.py'),
                             'fastlite.kw.Table.get_last': ('kw.html#table.get_last', 'fastlite/kw.py'),
                             'fastlite.kw.Table.ids_and_rows_where': ('kw.html#table.ids_and_rows_where', 'fastlite/kw.py'),
                             'fastlite.kw.Table.insert': ('kw.html#table.insert', 'fastlite/kw.py'),
                             'fastlite.kw.Table.insert_all': ('kw.html#table.insert_all', 'fastlite/kw.py'),
                             'fastlite.kw.Table.lookup': ('kw.html#table.lookup', 'fastlite/kw.py'),
                             'fastlite.kw.Table.transform': ('kw.html#table.transform', 'fastlite/kw.py'),
                             'fastlite.kw.Table.transform_sql': ('kw.html#table.transform_sql', 'fastlite/kw.py'),
                             'fastlite.kw.Table.update': ('kw.html#table.update', 'fastlite/kw.py'),
                             'fastlite.kw.Table.upsert': ('kw.html#table.upsert', 'fastlite/kw.py'),
                             'fastlite.kw.Table.xtra': ('kw.html#table.xtra', 'fastlite/kw.py'),
                             'fastlite.kw._process_row': ('kw.html#_process_row', 'fastlite/kw.py'),
                             'fastlite.kw.database': ('kw.html#database', 'fastlite/kw.py')}}}
