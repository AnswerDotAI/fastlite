...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_kw.py.ipynb.

# %% auto 0
__all__ = ['opt_bool', 'NotFoundError', 'database']

# %% ../nbs/01_kw.py.ipynb 2
...
# %% ../nbs/01_kw.py.ipynb 3
opt_bool = Union[bool, Default, None]
class NotFoundError(NotFoundError): pass

# %% ../nbs/01_kw.py.ipynb 4
...
# %% ../nbs/01_kw.py.ipynb 5
@patch
def xtra(self:Table, **kwargs):
    "Set `xtra_id`"
    self.xtra_id = kwargs

# %% ../nbs/01_kw.py.ipynb 6
@patch
